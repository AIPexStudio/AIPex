...
export type McpRequest =
  ...
  | {
      ...
      args: { title: string; url: string; parentId?: string };
    }
  ...
  | {
      tool: "build_url";
      args: { baseUrl: string; parameters: Record<string, string> };
    }
  ...
  | {
      tool: "download_text_as_markdown";
      args: {
        text: string;
        filename?: string;
        folderPath?: string;
  ...
  | {
      tool: "download_image";
      args: { imageData: string; filename?: string; folderPath?: string };
    }
  | {
      tool: "download_chat_images";
      args: {
        messages: Array<{
          id: string;
          parts?: Array<{
  ...
  | {
      tool: "download_current_chat_images";
      args: {
        folderPrefix?: string;
        imageNames?: string[];
        filenamingStrategy?: string;
    ...
    switch (request.tool) {
      ...
      case "delete_bookmark": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to delete bookmark",
            };
      }
      ...
      case "delete_history_item": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to delete history item",
            };
      }
      case "clear_history": {
      ...
      case "switch_to_window": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to switch window",
            };
      }
      ...
      case "close_window": {
        ...
        return result.success
          ? { success: true }
          : { success: false, error: result.error || "Failed to close window" };
      }
      case "minimize_window": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to minimize window",
            };
      }
      case "maximize_window": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to maximize window",
            };
      }
      // Tab group management
      ...
      case "create_tab_group": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to create tab group",
            };
      }
      case "update_tab_group": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to update tab group",
            };
      }
      // Utility functions
      case "get_tab_info": {
      ...
      case "duplicate_tab": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to duplicate tab",
            };
      }
      case "close_tab": {
        const { tabId } = request.args;
        ...
        return result.success
          ? { success: true }
          : { success: false, error: result.error || "Failed to close tab" };
      }
      // Page content
      ...
      case "highlight_element": {
        ...
        if (!selector) return { success: false, error: "Selector is required" };
        const result = await highlightElement(selector, {
          color,
          duration,
          intensity,
          persist,
      ...
      case "highlight_text_inline": {
        ...
        const result = await highlightTextInline(selector, searchText, {
          caseSensitive,
          wholeWords,
          highlightColor,
          backgroundColor,
      ...
      case "copy_to_clipboard": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to copy to clipboard",
            };
      }
      case "read_from_clipboard": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to read from clipboard",
            };
      }
      case "copy_current_page_url": {
        ...
        return result.success
          ...
          : { success: false, error: result.error || "Failed to copy URL" };
      }
      case "copy_current_page_title": {
        const result = await copyCurrentPageTitle();
        return result.success
          ? { success: true, data: result.title }
          : { success: false, error: result.error || "Failed to copy title" };
      }
      case "copy_selected_text": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to copy selected text",
            };
      }
      case "copy_page_as_markdown": {
        const result = await copyPageAsMarkdown();
        return result.success
          ? { success: true, data: result.markdown }
          : {
              success: false,
              error: result.error || "Failed to copy page as markdown",
            };
      }
      case "copy_page_as_text": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to copy page as text",
            };
      }
      case "copy_page_links": {
        const result = await copyPageLinks();
        return result.success
          ? { success: true, data: result.links }
          : {
              success: false,
              error: result.error || "Failed to copy page links",
            };
      }
      case "copy_page_metadata": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to copy page metadata",
            };
      }
      // Storage
      case "get_storage_value": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to get storage value",
            };
      }
      case "set_storage_value": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to set storage value",
            };
      }
      case "remove_storage_value": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to remove storage value",
            };
      }
      case "get_all_storage_keys": {
        const result = await getAllStorageKeys();
        return result.success
          ? { success: true, data: result.keys }
          : {
              success: false,
      ...
      case "get_extension_settings": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to get extension settings",
            };
      }
      case "update_extension_settings": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to update extension settings",
            };
      }
      case "get_ai_config": {
        const result = await getAiConfig();
        return result.success
          ? { success: true, data: result.config }
          : {
              success: false,
      ...
      case "export_storage_data": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to export storage data",
            };
      }
      case "import_storage_data": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to import storage data",
            };
      }
      ...
      case "format_timestamp": {
        ...
        return result.success
          ? { success: true, data: result.formatted }
          : {
              success: false,
              error: result.error || "Failed to format timestamp",
            };
      }
      case "generate_random_string": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to generate random string",
            };
      }
      case "validate_url": {
        const { url } = request.args;
        ...
        return result.success
          ? { success: true, data: result.isValid }
          : { success: false, error: result.error || "Failed to validate URL" };
      }
      case "extract_domain": {
        const { url } = request.args;
        if (!url) return { success: false, error: "URL is required" };
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to extract domain",
            };
      }
      case "get_url_parameters": {
        ...
        return result.success
          ? { success: true, data: result.parameters }
          : {
              success: false,
              error: result.error || "Failed to get URL parameters",
            };
      }
      case "build_url": {
        ...
        return result.success
          ? { success: true, data: result.url }
          : { success: false, error: result.error || "Failed to build URL" };
      }
      case "get_text_stats": {
        const { text } = request.args;
        if (!text) return { success: false, error: "Text is required" };
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to get text stats",
            };
      }
      case "convert_text_case": {
        const { text, caseType } = request.args;
        if (!text || !caseType)
          return { success: false, error: "Text and case type are required" };
        const result = await convertTextCase(text, caseType as any);
        return result.success
          ? { success: true, data: result.result }
          : {
              success: false,
              error: result.error || "Failed to convert text case",
            };
      }
      ...
      case "get_all_extensions": {
        ...
        return result.success
          ? { success: true, data: result.extensions }
          : {
              success: false,
              error: result.error || "Failed to get extensions",
            };
      }
      case "get_extension": {
        ...
        return result.success
          ? { success: true, data: result.extension }
          : {
              success: false,
              error: result.error || "Failed to get extension",
            };
      }
      case "set_extension_enabled": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to set extension enabled",
            };
      }
      ...
      case "get_extension_permissions": {
        ...
        return result.success
          ? { success: true, data: result.permissions }
          : {
              success: false,
              error: result.error || "Failed to get extension permissions",
            };
      }
      // Downloads
      case "get_all_downloads": {
        ...
        return result.success
          ? { success: true, data: result.downloads }
          : {
              success: false,
              error: result.error || "Failed to get downloads",
            };
      }
      case "get_download": {
        ...
        return result.success
          ? { success: true, data: result.download }
          : { success: false, error: result.error || "Failed to get download" };
      }
      case "pause_download": {
        const { downloadId } = request.args;
        if (!Number.isFinite(downloadId))
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to pause download",
            };
      }
      case "resume_download": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to resume download",
            };
      }
      ...
      case "remove_download": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to remove download",
            };
      }
      case "open_download": {
        const { downloadId } = request.args;
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to open download",
            };
      }
      case "show_download_in_folder": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to show download in folder",
            };
      }
      case "get_download_stats": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to get download stats",
            };
      }
      case "download_text_as_markdown": {
        ...
        if (result.success) {
          ...
          return {
            success: false,
            error: result.error || "Failed to download text as markdown",
          };
        }
      }
      case "download_image": {
      ...
      case "download_chat_images": {
        ...
        const result = await downloadChatImages(
          messages,
          folderPrefix,
          filenamingStrategy,
        );
        ...
        if (result.success) {
          ...
          return {
            success: false,
            error:
              result.errors?.join(", ") || "Failed to download chat images",
          };
        }
      }
      case "download_current_chat_images": {
        console.log(
          "🎯 [DEBUG] MCP Tool download_current_chat_images called:",
          request.args,
        );
        const {
          folderPrefix,
        ...
        try {
          console.log(
            "📤 [DEBUG] Calling background download function directly...",
          );

          // Import and call the background download function directly
          if (
            typeof (globalThis as any)
              .downloadCurrentChatImagesFromBackground === "function"
          ) {
            const result = await (
              globalThis as any
            ).downloadCurrentChatImagesFromBackground(
            ...
            if (result.success) {
              ...
              return {
                success: false,
                error: result.error || "Failed to download current chat images",
              };
            }
          } else {
            console.error(
              "❌ [DEBUG] Background download function not available",
            );
            return {
              success: false,
              error: "Download function not available in background context",
            };
          }
        } catch (error: any) {
          ...
          return {
            ...
            error:
              error?.message ||
              String(error) ||
              "Failed to access current chat images",
          };
        }
      }
      // Sessions
      case "get_all_sessions": {
        ...
        return result.success
          ? { success: true, data: result.sessions }
          : { success: false, error: result.error || "Failed to get sessions" };
      }
      case "get_session": {
        ...
        return result.success
          ...
          : { success: false, error: result.error || "Failed to get session" };
      }
      ...
      case "get_current_device": {
        ...
        return result.success
          ? { success: true, data: result.device }
          : {
              success: false,
              error: result.error || "Failed to get current device",
            };
      }
      case "get_all_devices": {
        const result = await getAllDevices();
        return result.success
          ? { success: true, data: result.devices }
          : {
              success: false,
              error: result.error || "Failed to get all devices",
            };
      }
      // Context Menus
      case "create_context_menu_item": {
        ...
        const result = await createContextMenuItem({
          id,
          title,
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to create context menu item",
            };
      }
      case "update_context_menu_item": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to update context menu item",
            };
      }
      case "remove_context_menu_item": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to remove context menu item",
            };
      }
      case "remove_all_context_menu_items": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to remove all context menu items",
            };
      }
      case "get_context_menu_items": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to get context menu items",
            };
      }
      // Screenshot tools
      case "capture_screenshot": {
        ...
        return result.success
          ? { success: true, data: { imageData: result.imageData } }
          : {
              success: false,
      ...
      case "capture_tab_screenshot": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to capture tab screenshot",
            };
      }
      case "capture_screenshot_to_clipboard": {
        ...
        return result.success
          ...
          : {
              success: false,
              error:
                result.error || "Failed to capture screenshot to clipboard",
            };
      }
      case "read_clipboard_image": {
        ...
        return result.success
          ...
          : {
              success: false,
              error: result.error || "Failed to read clipboard image",
            };
      }
      case "get_clipboard_image_info": {
        ...
        return result.success
          ? {
              success: true,
              data: { hasImage: result.hasImage, imageType: result.imageType },
            }
          : {
              success: false,
              error: result.error || "Failed to get clipboard image info",
            };
      }
      default:
