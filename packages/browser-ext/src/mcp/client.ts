...
export class BrowserMcpClient {
  ...
  private baseTools = [
    ...
    */
    ...
    },
    {
      ...
      description:
        "Extract text content from the current page with word count and reading time",
      action: false,
      inputSchema: {
        type: "object",
        properties: {},
    ...
    },
    {
      ...
      description:
        "Get all interactive elements (links, buttons, inputs) from the current page with optimized performance",
      action: false,
      inputSchema: {
        type: "object",
        properties: {},
    ...
    },
    {
      name: "click_element",
      description:
        "Click an element on the current page using its CSS selector",
      action: true,
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      name: "summarize_page",
      description:
        "Summarize the current page content with key points and reading statistics",
      action: false,
      inputSchema: {
        type: "object",
        properties: {},
    ...
    },
    {
      ...
      description:
        "Get all form elements and their input fields on the current page",
      action: false,
      inputSchema: {
        type: "object",
        properties: {},
      ...
      inputSchema: {
        ...
        properties: {
          selector: {
            type: "string",
            description:
              "CSS selector of the element to scroll to (e.g., '#my-element', '.content', 'h2')",
          },
        },
        required: ["selector"],
      },
    },
    {
      ...
      description:
        "Permanently highlight DOM elements with drop shadow effect and intelligent auto-color detection for maximum contrast",
      inputSchema: {
        type: "object",
        properties: {
          selector: {
            type: "string",
            description:
              "CSS selector of the element to highlight (e.g., '#my-element', '.content', 'h2')",
          },
          color: {
            type: "string",
            description:
              "Shadow color (e.g., '#00d4ff', '#ff0066', '#00ff88'). If not specified, automatically selects the highest contrast color based on element's background and text colors for optimal visibility",
          },
          duration: {
            type: "number",
            description:
              "Duration in milliseconds to show highlight. Default: 0 (permanent highlight)",
          },
          intensity: {
            type: "string",
            enum: ["subtle", "normal", "strong"],
            description:
              "Shadow intensity: 'subtle' (gentle), 'normal' (default), 'strong' (dramatic)",
          },
          persist: {
            type: "boolean",
            description:
              "Whether to keep the highlight permanently. Default: true (permanent highlight)",
          },
        },
        required: ["selector"],
      },
    },
    {
      ...
      description:
        "Highlight specific words or phrases within text content using inline styling (bold + red color)",
      inputSchema: {
        type: "object",
        properties: {
          selector: {
            type: "string",
            description:
              "CSS selector of the element(s) containing the text to search (e.g., 'p', '.content', 'article')",
          },
          searchText: {
            type: "string",
            description:
              "The text or phrase to highlight within the selected elements",
          },
          caseSensitive: {
            type: "boolean",
            description:
          ...
          highlightColor: {
            type: "string",
            description:
              "Color for the highlighted text. Default: '#DC143C' (crimson red)",
          },
          backgroundColor: {
            type: "string",
            description:
              "Background color for the highlighted text. Default: 'transparent'",
          },
          fontWeight: {
            type: "string",
            description:
              "Font weight for the highlighted text. Default: 'bold'",
          },
          persist: {
            type: "boolean",
            description:
              "Whether to keep the highlights permanently. Default: true",
          },
        },
    ...
    */
    {
      ...
      description:
        "Download text content as a markdown file to the user's local filesystem. Generate a descriptive filename and folder structure based on the content type and purpose.",
      inputSchema: {
        type: "object",
        properties: {
          text: {
          ...
          filename: {
            type: "string",
            description:
              "Descriptive filename for the download (without .md extension). Generate this based on the content type, purpose, or topic. Examples: 'meeting-notes-2024-01-15', 'api-documentation', 'project-summary'. If not provided, a timestamped filename will be generated.",
          },
          folderPath: {
            type: "string",
            description:
              "Optional folder path for organizing downloads based on content type or project (e.g., 'Meeting-Notes/2024', 'Documentation/API', 'Reports/Weekly'). Creates nested folder structure for better organization.",
          },
          displayResults: {
            type: "boolean",
            description:
              "Whether to display the download results with file path and organization summary. Default: true",
          },
        },
        required: ["text"],
      },
    },
    {
      name: "download_image",
      description:
        "Download an image from base64 data to the user's local filesystem. Generate a descriptive filename and folder structure based on the image content.",
      inputSchema: {
        type: "object",
        properties: {
          imageData: {
          ...
          filename: {
            type: "string",
            description:
              "Descriptive filename for the download (without extension). Generate this based on the image content or purpose. If not provided, a timestamped filename will be generated.",
          },
          folderPath: {
            type: "string",
            description:
              "Optional folder path for organizing downloads (e.g., 'Screenshots/Website-Analysis', 'AI-Generated/Diagrams'). Creates nested folder structure.",
          },
        },
        required: ["imageData"],
      },
    },
    {
      ...
      description:
        "Download multiple images from chat messages to the user's local filesystem. Generate descriptive filenames and folder structure based on the images content and conversation context. Display the download results including file paths and organization.",
      inputSchema: {
        type: "object",
        properties: {
          messages: {
                  ...
                  items: {
                    ...
                    properties: {
                      type: {
                        type: "string",
                        description:
                          "Part type (should be 'image' for image parts)",
                      },
                      imageData: {
                        type: "string",
          ...
          folderPrefix: {
            type: "string",
            description:
              "Descriptive folder name for organizing downloads based on conversation context (e.g., 'Website-Analysis-2024', 'AI-Diagrams-Session', 'Screenshots-Research'). If not provided, will generate based on conversation content.",
          },
          filenamingStrategy: {
            type: "string",
            description:
              "Strategy for naming files: 'descriptive' (based on content), 'sequential' (numbered), or 'timestamp' (time-based). Default: 'descriptive'",
            enum: ["descriptive", "sequential", "timestamp"],
          },
          displayResults: {
            type: "boolean",
            description:
              "Whether to display the download results with file paths and organization summary. Default: true",
          },
        },
        required: ["messages"],
      },
    ...
    */
    // Screenshot tools
    {
      ...
      description:
        "Capture screenshot of current visible tab and return as base64 data URL. Summarize your actions or describe the highlighted sections and generate an image name to display.",
      inputSchema: {
        type: "object",
        properties: {},
        required: [],
    ...
    },
    {
      ...
      description:
        "Capture screenshot of a specific tab by ID. Summarize your actions or describe the highlighted sections and generate an image name to display.",
      inputSchema: {
        type: "object",
        properties: {
          tabId: {
    ...
    },
    {
      ...
      description:
        "Capture screenshot of current tab and save directly to clipboard. Summarize your actions or describe the highlighted sections and generate an image name to display.",
      inputSchema: {
        type: "object",
        properties: {},
        required: [],
    ...
    // },
    {
      ...
      description:
        "Download all images from current AI chat conversation to local storage. You can specify custom names for each image or use automatic naming strategies.",
      inputSchema: {
        type: "object",
        properties: {
          folderPrefix: {
            type: "string",
            description:
              "Descriptive folder name for organizing downloads (e.g., 'Website-Analysis-2024', 'AI-Diagrams-Session', 'Screenshots-Research').",
          },
          imageNames: {
            type: "array",
            items: { type: "string" },
            description:
              "Custom names for each image in order. If provided, will use these names directly (e.g., ['网站首页截图', '用户登录界面', '错误页面']).",
          },
          filenamingStrategy: {
            type: "string",
            description:
              "Strategy for naming files when imageNames not provided: 'descriptive', 'sequential', or 'timestamp'. Default: 'descriptive'",
            enum: ["descriptive", "sequential", "timestamp"],
          },
          displayResults: {
            type: "boolean",
  ...
  async listTools() {
    console.log(
      "📋 [DEBUG] MCP Client listing tools:",
   ...
   */
  private async checkHostAccessForTool(
    toolName: string,
    args: any,
    ...
    if (toolName === "create_new_tab") {
      ...
      try {
        ...
        return {
          allowed: false,
          reason: `Cannot access tab ${args.tabId}: ${e}`,
        };
      }
    } else {
  ...
  async captureScreenshot() {
    const result = await callMcpTool({
      tool: "capture_screenshot" as any,
      args: {},
    });
