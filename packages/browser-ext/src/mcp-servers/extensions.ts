  ...
  try {
    ...
    return {
      ...
      error:
        error?.message ||
        String(error) ||
        "Failed to get extensions. Check if management permission is granted.",
    };
  }
}
  ...
  try {
    ...
    return {
      ...
      error:
        error?.message ||
        String(error) ||
        "Failed to get extension. Check if management permission is granted.",
    };
  }
}
  ...
  try {
    ...
    return {
      ...
      error:
        error?.message ||
        String(error) ||
        "Failed to set extension enabled. Check if management permission is granted.",
    };
  }
}
  ...
  try {
    ...
    return {
      ...
      error:
        error?.message ||
        String(error) ||
        "Failed to uninstall extension. Check if management permission is granted.",
    };
  }
}
...
export async function getExtensionPermissions(extensionId: string): Promise<{
  ...
  try {
    ...
    const _permissions =
      await chrome.management.getPermissionWarningsById(extensionId);
    const extension = await chrome.management.get(extensionId);
    ...
    return {
      ...
      error:
        error?.message ||
        String(error) ||
        "Failed to get extension permissions. Check if management permission is granted.",
    };
  }
}
