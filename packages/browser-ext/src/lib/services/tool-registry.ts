  ...
  private initializeTools(): void {
    ...
    try {
      ...
      > = {
        "Tab Management": {
          description:
            "Manage browser tabs, switch between them, and get tab information",
          tools: [
            "get_all_tabs",
            "get_current_tab",
            "switch_to_tab",
        ...
        Windows: {
          description:
            "Manage browser windows, create, switch, and control windows",
          tools: [
            "get_all_windows",
            "get_current_window",
            "switch_to_window",
        ...
        "Form & Input Management": {
          description:
            "Fill forms, manage input fields, and interact with web forms",
          tools: [
            "fill_input",
            "clear_input",
            "get_input_value",
