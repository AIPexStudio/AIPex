        ...
        options={{
          overrides: {
            ...
            pre: ({ children, ...props }) => {
              ...
              return (
                <pre
                  className="bg-gray-50 rounded-xl p-4 overflow-x-auto mb-4 border border-gray-200 font-mono text-sm leading-relaxed shadow-sm"
                  {...props}
                >
                  {children}
                </pre>
            ...
            p: {
              props: {
                className:
                  "mb-4 last:mb-0 text-gray-800 leading-relaxed text-base",
              },
            },
            // Heading styling
            h1: {
              props: {
                className:
                  "text-2xl font-bold mb-6 mt-8 text-gray-900 border-b border-gray-200 pb-3",
              },
            },
            h2: {
              props: {
            ...
            a: {
              props: {
                className:
                  "text-blue-600 hover:text-blue-700 underline transition-colors font-medium",
                target: "_blank",
            ...
            blockquote: {
              props: {
                className:
                  "border-l-4 border-blue-300 pl-6 italic text-gray-700 mb-6 bg-blue-50 py-4 rounded-r-xl shadow-sm",
              },
            },
            // Table styling
            table: {
              props: {
                className:
                  "border-collapse border border-gray-200 mb-6 text-gray-800 w-full rounded-xl overflow-hidden shadow-sm",
              },
            },
            th: {
              props: {
                className:
                  "border border-gray-200 px-4 py-3 bg-gray-50 text-gray-900 font-semibold text-left",
              },
            },
            td: {
              props: {
            ...
            img: {
              props: {
                className:
                  "rounded-xl border border-gray-200 max-w-full h-auto my-6 shadow-sm",
              },
            },
          },
        }}
