import type { AutomationTarget, SnapshotCaptureOptions, SnapshotResult } from "./browser-automation-host.js";
...
export interface RuntimeAddon {
    ...
    onAfterSnapshot?(result: SnapshotResult, ctx: SnapshotHookContext): Promise<void> | void;
}
