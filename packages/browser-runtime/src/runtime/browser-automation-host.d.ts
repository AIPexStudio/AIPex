...
export interface BrowserAutomationHost {
    ...
    captureSnapshot(target: AutomationTarget, options?: SnapshotCaptureOptions): Promise<SnapshotResult>;
    restoreCapture(snapshotId: string): Promise<void>;
    broadcastToTabs<TPayload>(message: RuntimeBroadcastMessage<TPayload>): Promise<void>;
}
