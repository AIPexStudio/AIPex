 ...
 */
export declare function scrollAndMoveFakeMouseToElement(options: FakeMouseScrollOptions): Promise<{
    x: number;
    y: number;
    width: number;
    height: number;
 ...
 */
export declare function playClickAnimationAndReturn(tabId: number): Promise<void>;
