...
export const loadSkillTool = tool({
    name: "load_skill",
    description: "Load the main content (SKILL.md) of a skill. Use this to understand what a skill does, its capabilities, available scripts, and how to use it.",
    parameters: z.object({
...
export const executeSkillScriptTool = tool({
    ...
    description: "Execute a script that belongs to a skill. Scripts are located in the scripts/ directory of the skill package and can perform various operations.",
    parameters: z.object({
        skillName: z.string().describe("The name of the skill"),
        scriptPath: z
            .string()
            .describe('The path to the script file (e.g., "scripts/init_skill.js"), MUST start with "scripts/"'),
        args: z
            .unknown()
            .nullable()
            .optional()
...
export const readSkillReferenceTool = tool({
    ...
    description: "Read a reference document from a skill. Reference files are located in the references/ directory and contain additional documentation, guides, or examples.",
    parameters: z.object({
        skillName: z.string().describe("The name of the skill"),
        refPath: z
            .string()
            .describe('The path to the reference file (e.g., "references/guide.md"), MUST start with "references/"'),
    }),
...
export const getSkillAssetTool = tool({
    ...
    description: "Get an asset file from a skill. Assets are located in the assets/ directory and can be images, data files, or other resources.",
    parameters: z.object({
        skillName: z.string().describe("The name of the skill"),
        assetPath: z
            .string()
            .describe('The path to the asset file (e.g., "assets/icon.png"), MUST start with "assets/"'),
    }),
...
export const listSkillsTool = tool({
    name: "list_skills",
    description: "List all available skills in the system. Shows enabled skills by default, or all skills if specified.",
    parameters: z.object({
        enabledOnly: z
            .boolean()
            .nullable()
...
export const getSkillInfoTool = tool({
    name: "get_skill_info",
    description: "Get detailed information about a specific skill, including its scripts, references, assets, and metadata.",
    parameters: z.object({
        skillName: z.string().describe("The name of the skill"),
    }),
