...
* \`hover\`: Move the mouse cursor to the specified coordinates without clicking. Useful for revealing tooltips, dropdown menus, or triggering hover states.`),
        coordinate: z
            ...
            .nullable()
            .optional()
            .describe("(x, y): The x (pixels from the left edge) and y (pixels from the top edge) coordinates in screenshot pixel space. Required for left_click, right_click, double_click, triple_click, scroll, and hover. For left_click_drag, this is the end position."),
        text: z
            .string()
            .nullable()
            .optional()
        ...
        start_coordinate: z
            ...
            .nullable()
            .optional()
            .describe("Starting coordinates for left_click_drag action in screenshot pixel space."),
        scroll_direction: z
        ...
        scroll_amount: z
            ...
            .nullable()
            .optional()
            .describe("Number of pixels to scroll. Defaults to ~2 viewport heights for standard scrolling."),
        duration: z
            .number()
            .nullable()
            .optional()
        ...
        tabId: z
            ...
            .nullable()
            .optional()
            .describe("The ID of the tab to operate on. Defaults to current active tab."),
        uid: z
            .string()
            .nullable()
            .optional()
