 ...
 */
export declare const listInterventionsTool: import("@openai/agents").FunctionTool<
  unknown,
  z.ZodObject<
    {
 ...
 */
export declare const getInterventionInfoTool: import("@openai/agents").FunctionTool<
  unknown,
  z.ZodObject<
    {
      type: z.ZodEnum<{
 ...
 */
export declare const requestInterventionTool: import("@openai/agents").FunctionTool<
  unknown,
  z.ZodObject<
    {
      type: z.ZodEnum<{
 ...
 */
export declare const cancelInterventionTool: import("@openai/agents").FunctionTool<
  unknown,
  z.ZodObject<
    {
 ...
 */
export declare const interventionTools: import("@openai/agents").FunctionTool<
  unknown,
  z.ZodObject<
    {
      enabledOnly: z.ZodDefault<z.ZodBoolean>;
