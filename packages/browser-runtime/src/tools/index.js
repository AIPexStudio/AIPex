...
import { clickTool, fillElementByUidTool, fillFormTool, getEditorValueTool, hoverElementByUidTool, } from "./element";
import { interventionTools } from "./interventions/index.js";
import { getPageMetadataTool, highlightElementTool, highlightTextInlineTool, scrollToElementTool, } from "./page";
...
import { closeTabTool, createNewTabTool, getAllTabsTool, getCurrentTabTool, getTabInfoTool, organizeTabsTool, ungroupTabsTool, } from "./tab";
 ...
 */
export function registerDefaultBrowserTools(registry) {
 ...
 */
export async function executeScriptInTab(tabId, func, args) {
 ...
 */
export async function executeScriptInActiveTab(func, args) {
