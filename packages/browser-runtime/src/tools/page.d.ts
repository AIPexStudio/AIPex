 ...
 */
export declare const getPageMetadataTool: import("@openai/agents").FunctionTool<unknown, z.ZodObject<{}, z.core.$strip>, string>;
/**
 * Scroll to a DOM element and center it in the viewport
 */
export declare const scrollToElementTool: import("@openai/agents").FunctionTool<unknown, z.ZodObject<{
    selector: z.ZodString;
}, z.core.$strip>, string>;
/**
 * Permanently highlight DOM elements with drop shadow effect
 */
export declare const highlightElementTool: import("@openai/agents").FunctionTool<unknown, z.ZodObject<{
    selector: z.ZodString;
    color: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    duration: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    intensity: z.ZodOptional<z.ZodNullable<z.ZodEnum<{
        strong: "strong";
        normal: "normal";
        subtle: "subtle";
    }>>>;
 ...
 */
export declare const highlightTextInlineTool: import("@openai/agents").FunctionTool<unknown, z.ZodObject<{
    selector: z.ZodString;
