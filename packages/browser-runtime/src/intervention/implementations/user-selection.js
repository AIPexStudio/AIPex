...
class SelectionManager {
    ...
    completeSelection(result) {
        if (this.currentRequest) {
            console.log("[SelectionManager] Completing selection with result:", result);
...
const metadata = {
    name: "User Selection",
    type: "user-selection",
    description: "Show questions and options to users, let them choose one or more answers",
    enabled: true,
    inputSchema: {
        type: "object",
        properties: {
...
async function execute(params, signal) {
    ...
    const normalizedParams = {
        ...
        reason: "reason" in paramsObj && typeof paramsObj.reason === "string"
            ? paramsObj.reason
            : undefined,
    };
