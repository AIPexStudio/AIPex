...
async function checkMicrophonePermission() {
    try {
        ...
        console.error("[VoiceInput] Microphone permission error:", errorName, errorMsg);
...
const metadata = {
    name: "Voice Input",
    type: "voice-input",
    description: "Get user voice input, supports browser speech recognition or ElevenLabs API",
    enabled: true,
    inputSchema: {
        type: "object",
        properties: {
...
async function execute(params, signal) {
    ...
    const paramsObj = typeof params === "object" && params !== null
        ? params
        : {};
    const language = "language" in paramsObj && typeof paramsObj.language === "string"
        ? paramsObj.language
        : "zh-CN";
    const autoStopSilence = "autoStopSilence" in paramsObj &&
...
export const voiceInputIntervention = {
    metadata,
    execute,
};
