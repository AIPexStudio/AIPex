 ...
 * Intervention status
 */
export type InterventionStatus = "pending" | "active" | "completed" | "cancelled" | "timeout" | "error";
/**
 * Intervention type
 */
export type InterventionType = "monitor-operation" | "voice-input" | "user-selection";
/**
 ...
 */
export type InterventionEventType = "request" | "start" | "progress" | "complete" | "cancel" | "timeout" | "error";
/**
 * Intervention event
 */
