 ...
 * - Event notifications
 */
import type { InterventionEvent, InterventionEventType, InterventionMode, InterventionResult, InterventionState, InterventionType } from "./types.js";
...
export declare class InterventionManager {
     ...
     */
    requestIntervention(type: InterventionType, params?: unknown, timeout?: number, reason?: string): Promise<InterventionResult>;
    /**
     ...
     */
    removeEventListener(type: InterventionEventType, listener: EventListener): void;
    /**
     * Emit event
     */
    private emitEvent;
