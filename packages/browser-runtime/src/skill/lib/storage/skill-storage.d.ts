...
export declare class SkillStorage {
    ...
    getSkillFile(skillId: string, filePath: string): Promise<string | ArrayBuffer | null>;
    /**
     ...
     */
    createSkillFromZenFS(name: string, description: string, version: string, sourcePath: string): Promise<SkillMetadata>;
