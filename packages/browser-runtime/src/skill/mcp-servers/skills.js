...
export async function executeSkillScript(skillName, scriptPath, args) {
    try {
...
export async function readSkillReference(skillName, refPath) {
    try {
...
export async function getSkillAsset(skillName, assetPath) {
    try {
        ...
        return {
            success: true,
            asset: asset instanceof ArrayBuffer
...
export async function getSkillTools(skillName) {
    try {
