...
import { VOICE_MODE_CONFIG } from "./config.js";
...
export class ParticleSystem {
  ...
  private animate = () => {
    ...
    if (this.uniforms.uRadius) this.uniforms.uRadius.value = this.currentRadius;
  ...
  public setState(state: VoiceState) {
    ...
    switch (state) {
      case "idle":
        if (this.uniforms.uState) this.uniforms.uState.value = 0;
        this.targetRadius = 1.5; // Reduced from 2.2
        break;
      case "listening":
        if (this.uniforms.uState) this.uniforms.uState.value = 1;
        this.targetRadius = 1.8; // Reduced from 2.6
        break;
      case "speaking":
        if (this.uniforms.uState) this.uniforms.uState.value = 2;
        this.targetRadius = 1.6; // Reduced from 2.4
        break;
      case "processing":
        if (this.uniforms.uState) this.uniforms.uState.value = 0;
        this.targetRadius = 1.4; // Reduced from 2.0
        break;
    }
  }
